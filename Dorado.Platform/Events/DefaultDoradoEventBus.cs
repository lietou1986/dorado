...
using Dorado.Platform.Exceptions;
using System;
...
{
    public class DefaultDoradoEventBus : IEventBus
    {
        ...
        public DefaultDoradoEventBus(IIndex<string, IEnumerable<IEventHandler>> eventHandlers, IExceptionPolicy exceptionPolicy)
        {
