...
using Dorado.Platform.Packaging;
    ...
    public class PluginManager
    {
        ...
        public static void Initialize()
        {
            ...
            using (Locker.Write())
            {
                ...
                _clearShadowDirectoryOnStartup = CommonHelper.GetAppSetting("ClearPluginsShadowDirectoryOnStartup", true);
                try
                {
        ...
        public static bool IsAssumedCompatible(Version minAppVersion)
        {
            ...
            if (PlatformVersion.Version == minAppVersion)
            {
                return true;
            }
            ...
            foreach (var version in PlatformVersion.BreakingChangesHistory)
            {
        ...
        private static Assembly Probe(FileInfo plug)
        {
            if (plug.Directory == null || plug.Directory.Parent == null)
                throw new InvalidOperationException("The plugin directory for the " + plug.Name +
                                                    " file exists in a folder outside of the allowed DoradoPlatform folder hierarchy");
