...
namespace Dorado.Platform.Plugins
{
    ...
    public class PluginDescriptor : IComparable<PluginDescriptor>
    {
        ...
        public PluginDescriptor()
        {
            ...
            this.MinAppVersion = PlatformVersion.Version;
        }
        ...
        {
            object instance;
            if (!DoradoContext.Instance.ContainerManager.TryResolve(PluginType, null, out instance))
            {
                //not resolved
                instance = DoradoContext.Instance.ContainerManager.ResolveUnregistered(PluginType);
            }
