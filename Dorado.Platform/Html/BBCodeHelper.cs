using Dorado.Platform.Html.CodeFormatter;
using System;
using System.Text.RegularExpressions;

namespace Dorado.Platform.Html
{
    /// <summary>
    ...
    public partial class BBCodeHelper
    {
            ...
            bool replaceUnderline, bool replaceUrl, bool replaceCode, bool replaceQuote)
        {
            ...
            if (replaceUrl)
            {
                // format the url tags: [url=http://www.Dorado.Platform.com]my site[/url]
                // becomes: <a href="http://www.Dorado.Platform.com">my site</a>
                text = regexUrl1.Replace(text, "<a href=\"$1\" rel=\"nofollow\">$2</a>");

                // format the url tags: [url]http://www.Dorado.Platform.com[/url]
                // becomes: <a href="http://www.Dorado.Platform.com">http://www.Dorado.Platform.com</a>
