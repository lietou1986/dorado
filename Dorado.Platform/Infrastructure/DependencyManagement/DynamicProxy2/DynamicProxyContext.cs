...
namespace Dorado.Platform.Infrastructure.DependencyManagement.DynamicProxy2
{
    ...
    {
        private const string ProxyContextKey = "Dorado.Platform.Environment.AutofacUtil.DynamicProxy2.DynamicProxyContext.ProxyContextKey";
        private const string InterceptorServicesKey = "Dorado.Platform.Environment.AutofacUtil.DynamicProxy2.DynamicProxyContext.InterceptorServicesKey";
