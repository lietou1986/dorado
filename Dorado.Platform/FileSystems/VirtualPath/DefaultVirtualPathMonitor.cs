    ...
    public class DefaultVirtualPathMonitor : IVirtualPathMonitor
    {
        ...
        public IVolatileToken WhenPathChanges(string virtualPath)
        {
            ...
            catch (HttpException e)
            {
                ...
                LoggerWrapper.Logger.Info(string.Format("Error monitoring file changes on virtual path '{0}'", virtualPath), e);
        ...
        private void BindSignal(string virtualPath, CacheItemRemovedCallback callback)
        {
            ...
            LoggerWrapper.Logger.Debug("Monitoring virtual path \"{0}\"", virtualPath);
        ...
        public void Signal(string key, object value, CacheItemRemovedReason reason)
        {
            ...
            LoggerWrapper.Logger.Debug("Virtual path changed ({1}) '{0}'", virtualPath, reason.ToString());
