...
namespace Dorado.Platform.FileSystems.AppData
{
    public class AppDataFolder : IAppDataFolder
    {
        ...
        private void MakeDestinationFileNameAvailable(string destinationFileName)
        {
            ...
            {
                LoggerWrapper.Logger.Warn("Could not delete recipe execution folder {0} under \"App_Data\" folder", destinationFileName);
                return;
            }
            ...
            {
                throw new CoreException("Unable to make room for file \"{0}\" in \"App_Data\" folder", destinationFileName, e);
            }
        }
        ...
        {
            LoggerWrapper.Logger.Info("Storing file \"{0}\" as \"{1}\" in \"App_Data\" folder", sourceFileName, destinationPath);
        ...
        {
            LoggerWrapper.Logger.Info("Deleting file \"{0}\" from \"App_Data\" folder", path);
