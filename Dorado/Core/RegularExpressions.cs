...
namespace Dorado.Core
{
    public static class RegularExpressions
    {
        ...
        public static readonly Regex IsMobile = new Regex(@"^[1][3-9][0-9]{9}$", RegexOptions.Compiled);
        ...
        public static readonly Regex IsTel = new Regex(@"^(\d{2,4}[-_－—]?)?\d{3,8}([-_－—]?\d{3,8})?([-_－—]?\d{1,7})?$", RegexOptions.Compiled);
        public static readonly Regex IsQQ = new Regex("^[1-9]*[1-9][0-9]*$", RegexOptions.Compiled);
        public static readonly Regex IsChinese = new Regex("[\u4e00 - \u9fa5] + ", RegexOptions.Compiled);
        public static readonly Regex IsIDCard = new Regex(@"(^[1-9]\d{5}[1-9]\d{3}((0\d)|(1[0-2]))(([0|1|2]\d)|3[0-1])((\d{4})|\d{3}[A-Z])$)|(^[1-9]\d{7}((0\d)|(1[0-2]))(([0|1|2]\d)|3[0-1])\d{3}$)", RegexOptions.Compiled);
    }
}