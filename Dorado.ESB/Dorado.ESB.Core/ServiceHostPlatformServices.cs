...
{
    #region ServiceHostPlatformServices

    public class ServiceHostPlatformServices : ServiceHost
    {
        private ServiceModelSection model = null;

        #region Constructors

        public ServiceHostPlatformServices(ServiceConfigData config, Type serviceType, Type interfaceType, params Uri[] baseAddress)
        ...
        protected override void ApplyConfiguration()
        {
            ...
            else
            {
                ...
                //ErrorBehaviorAttribute errBehavior = new ErrorBehaviorAttribute();
                //this.Description.Behaviors.Add(errBehavior);
            }
        }
    ...
    #endregion ServiceHostPlatformServices
}