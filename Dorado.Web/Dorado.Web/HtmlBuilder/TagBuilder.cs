namespace Dorado.Web.HtmlBuilder
{
    ...
    public class TagBuilder
    {
        ...
        public TagBuilder(string tagName)
        {
            ...
            {
                throw new ArgumentException("Value cannot be null or empty.", "tagName");
            }
        ...
        internal HtmlString ToMvcHtmlString(TagRenderMode renderMode)
        {
            return HtmlString.Create(ToString(renderMode));
        }
