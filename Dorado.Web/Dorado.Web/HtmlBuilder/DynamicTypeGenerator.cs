namespace Dorado.Web.HtmlBuilder
{
    ...
    internal static class DynamicTypeGenerator
    {
        ...
        {
            CustomAttributeBuilder builder = new CustomAttributeBuilder(con: typeof(SecurityTransparentAttribute).GetConstructor(Type.EmptyTypes), constructorArgs: new object[0]);
            CustomAttributeBuilder[] assemblyAttributes = new[] { builder };
        ...
        {
            TypeBuilder newType = DynamicModule.DefineType(
