...
using System.Xml;
using Dorado.UrlRewriter.Logging;
using Dorado.UrlRewriter.Parsers;
using Dorado.UrlRewriter.Transforms;
...
namespace Dorado.UrlRewriter.Configuration
{
    ...
    public class RewriterConfiguration : IRewriterConfiguration
    {
        ...
        public RewriterConfiguration(IConfigurationManager configurationManager)
        {
            ...
            _conditionParserPipeline.AddParser(new HostConditionParser());
            _conditionParserPipeline.AddParser(new AbsUrlMatchConditionParser());
