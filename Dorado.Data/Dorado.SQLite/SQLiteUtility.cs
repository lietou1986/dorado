...
namespace Dorado.SQLite
{
    /// <summary>
    /// SQLiteUtility is a utility class similar to "SQLHelper" in MS
    /// Data Access Application Block and follows similar pattern.
    /// </summary>
    public class SQLiteUtility
    {
        /// <summary>
        /// Creates a new <see cref="SQLiteUtility"/> instance. The ctor is marked private since all members are static.
        /// </summary>
