...
namespace Dorado.Data.Extensions
{
    ...
    {
        public static IAsyncResult BeginExecuteReader(this Database db, AsyncCallback callback, string procName, params object[] parameterValues)
        {
            ...
            catch (Exceptions.DataException)
            {
        ...
        public static IAsyncResult BeginExecuteNonQuery(this Database db, AsyncCallback callback, string procName, params object[] parameterValues)
        {
            SqlConnection connection = db.GetAsyncConnection();
            SqlCommand command = CommandFactory.CreateCommand(connection, db.InstanceName, procName, parameterValues);
            IAsyncResult result;
        ...
        public static void ExecuteAndMapResults(this Database database, string procedureName, Action<IParameterSet> parameterMapper, Action<IRecordSet> resultMapper)
        {
